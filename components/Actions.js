...
export default function Actions({play, canPlay}) {
    return (
        <View style={styles.actions}> 
            <TouchableOpacity 
                disabled={!canPlay} style={styles.actionButton} onPress={ () => play(1)}>
                <FontAwesome5 name="hand-rock" size={32} color="#6a5300"/>                     
            </TouchableOpacity>
            <TouchableOpacity 
                disabled={!canPlay} style={styles.actionButton} onPress={ () => play(2)}>
                <FontAwesome5 name="hand-paper" size={32} color="#6a5300"/>                     
            </TouchableOpacity>
            <TouchableOpacity 
                disabled={!canPlay} style={styles.actionButton} onPress={ () => play(3)}>
